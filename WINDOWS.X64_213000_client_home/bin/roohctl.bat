...
@set NETCFG_CLASSPATH=%OH%\jlib\ldapjclnt.jar;%OH%\jlib\ojmisc.jar;%OH%\jlib\oraclepki.jar;%OH%\jlib\opm.jar
...
@set ORACLE_HOME=%OH%
"%OH%\jdk\BIN\JAVA" -DIGNORE_PREREQS=%IGNORE_PREREQS% -DORACLE_HOME="%OH%" -Doracle.installer.not_bootstrap=true -DJDBC_PROTOCOL=thin -mx128m oracle.assistants.roohctl.RoohCtl  %*
