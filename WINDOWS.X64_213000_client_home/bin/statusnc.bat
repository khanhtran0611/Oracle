...
@echo  "----------------------------------------------------------------------"
@echo on
%JAVA_HOME%\bin\java -Xint -DJA_HOME=%JA_HOME% -DORACLE_HOME=C:\app09\oracle\base\product\21.0.0\clienthome_1 -DJA_LIBS_HOME=C:\app09\oracle\base\product\21.0.0\clienthome_1 -DJAVA_HOME=%JAVA_HOME% -DJAVA_HOME_CLASSPATH=%JAVA_HOME_CLASSPATH% -classpath %JACLASSPATH% oracle.jaccelerator.Status %args% 
@echo off
goto finish
