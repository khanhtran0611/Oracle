...
@set TNS_ADMIN=
@set ORACLE_HOME=%OH%
@set JRE_CLASSPATH=%OH%\jdk\lib\rt.jar
@set JRE_EXT_CLASSPATH=%OH%\jdk\lib\ext\sunjce_provider.jar
@set I18N_CLASSPATH=%OH%\jdk\lib\i18n.jar
...
"%OH%\JDK\BIN\JAVA" -DDEV_MODE=false -DTRACING.ENABLED=true -DTRACING.TOFILE=true -DTRACING.LEVEL=2 -DORACLE_HOME="%OH%" -Doracle.installer.not_bootstrap=true -mx128m oracle.sysman.assistants.rconfig.RConfig  %*
:End
exit /B %ERRORLEVEL%
