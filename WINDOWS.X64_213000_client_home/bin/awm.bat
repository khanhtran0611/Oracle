...
setlocal
set JAVA_RT=C:\app09\oracle\base\product\21.0.0\clienthome_1/jdk/jre\bin\java
...
cd %OH%\olap\awm
%JAVA_RT% -mx1024m -Dsun.java2d.noddraw=true -DORACLE_HOME=C:\app09\oracle\base\product\21.0.0\clienthome_1 -cp %CLASSPATH% %START% %1 %2 %3 %4 %5 %6 %7 %8 %9 > awmrun.log
endlocal
